...
# Mount your frontend folder (change "frontend" to your actual folder name)
...
# ✅ CORS headers added directly to StreamingResponse
STREAM_HEADERS = {
...
def webcam():
    return StreamingResponse(
        generate_stream("webcam"),
        media_type="multipart/x-mixed-replace; boundary=frame",
        headers=STREAM_HEADERS   # ✅ explicit headers
    )
